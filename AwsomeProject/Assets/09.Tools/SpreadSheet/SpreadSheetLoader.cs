...
public class SpreadSheetLoader : EditorWindow
{
    ...
    public void CreateGUI()
    {
        ...
        VisualTreeAsset = AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
            "Assets/09.Tools/SpreadSheet/SpreadSheetLoader.uxml");
    ...
    private void CreateSO(string fileName, int id, string itemName, int maxCarryAmountPerSlot, string itemExplain, Portion portionType)
    {
        Debug.Log("밍");
